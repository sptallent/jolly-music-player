...
public class CircularSeekBar extends View {
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mMax = attrArray.getInt(R.styleable.CircularSeekBar_max_seek, DEFAULT_MAX);
        mProgress = attrArray.getInt(R.styleable.CircularSeekBar_progress_seek, DEFAULT_PROGRESS);
